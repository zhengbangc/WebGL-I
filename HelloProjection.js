...
//basing on different selection from the html input, the graph will have different effects i.e. dancing/no dancing and animations
function setupBuffers() {
  ...
  if(document.getElementById("color_scheme").value == "blinking")
